...
SECRET_KEY = 'django-insecure-%zs!t5gn4c+i+)(u#@4!hdeh1jomvh85p^npu%s0)+s_y0p^z!'
...
SECURE_BROWSER_XSS_FILTER = True      # Protect against XSS in browser
...
# If Django is behind a proxy/load balancer, this ensures HTTPS is detected correctly
